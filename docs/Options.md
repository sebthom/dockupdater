...
This flag allows a more strict control over docupdater's updates. If the container or service does not have a `docupdater.enable` label, it will be ignored completely.
...
**Default:** `False`  
**Availability:** `containers`  
**Override label:** [`docupdater.cleamup`](Labels.md#cleanup)
...
**Default:** `False`  
**Availability:** `containers` `services`  
**Override label:** [`docupdater.latest`](Labels.md#latest)
...
**Default:** `None`  
**Availability:** `containers`  
**Override label:** [`docupdater.stop_signal`](Labels.md#stop_signal)
...
**Default:** `0`  
**Availability:** `containers` `services`  
**Override label:** [`docupdater.wait`](Labels.md#wait-time)
**Example:** `-e WAIT=60`  
...
**Default:** `0`  
**Availability:** `containers`  
**Override label:** [`docupdater.recreate_first`](Labels.md#recreate-first)
...
Self update of docupdater always use this feature.
...
**Default:** `None`  
**Override label:** [`docupdater.notifiers`](Labels.md#notifiers)
...
**Default:** `None`  
**Override label:** [`docupdater.template_file`](Labels.md#template-file)
